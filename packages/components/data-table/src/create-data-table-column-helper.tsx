...
import { DataTableActionCell } from "./internal/data-table-action-cell";
import {
	DataTableSelectCell,
	DataTableSelectHeader,
} from "./internal/data-table-select-cell";
import type {
	...
	return {
		accessor: (accessor, column) => {
			const {
				...
				enableSorting,
				...rest
				// biome-ignore lint/suspicious/noExplicitAny: nah, too generic ! :O
