import { Avatar, AvatarGroup, type AvatarGroupProps } from "@kopexa/sight";
...
const CustomSlotsTemplate = (args: AvatarGroupProps) => (
	<AvatarGroup {...args}>
		<Avatar
			classNames={{ root: "border-2 border-yellow-400" }}
			radius="sm"
			size="sm"
			src="https://i.pravatar.cc/150?u=a042581f4e29026024d"
		/>
		<Avatar
			classNames={{ root: "border-2 border-yellow-500" }}
			radius="sm"
			size="sm"
			src="https://i.pravatar.cc/150?u=a04258a2462d826712d"
		/>
		<Avatar
			classNames={{ root: "border-2 border-yellow-600" }}
			radius="sm"
			size="sm"
			src="https://i.pravatar.cc/150?u=a042581f4e29026704d"
		/>
		<Avatar
			classNames={{ root: "border-2 border-yellow-700" }}
			radius="sm"
			size="sm"
